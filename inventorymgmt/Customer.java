...
{    
    ...
    private void customerTableData()
    {
        try
        {
        ...
        {
            JOptionPane.showMessageDialog(Customer.this,e);    
        }
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
         try
         {
            ...
            pst.executeUpdate();
            JOptionPane.showMessageDialog(Customer.this, "CUSTOMER DELETED SUCCESSFULLY!");
            jTextField4.setText("");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try
        {
            String sql = "UPDATE customers SET CustomerName=?,CustomerContact=? WHERE CustomerID=?";
            conn = DriverManager.getConnection(url,uname,upass);
            pst = conn.prepareStatement(sql);
            ...
            pst.executeUpdate();
            JOptionPane.showMessageDialog(Customer.this, "CUSTOMER UPDATED SUCCESSFULLY!");
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField4.setText("");
